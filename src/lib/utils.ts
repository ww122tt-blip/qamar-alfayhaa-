...
export const IRAQI_DISTRICTS: Record<string, string[]> = {
  'ذي قار': ['الناصرية', 'الفجر', 'الرفاعي', 'القلعة', 'الشطرة', 'سوق الشيوخ', 'الجبايش', 'البطحاء', 'سيد دخيل', 'الدواية', 'النصر', 'الغراف', 'سوق الشيوخ'],
  'البصرة': ['المركز', 'الزبير', 'القرنة', 'شط العرب', 'أبو الخصيب', 'الفاو', 'سفوان', 'أم قصر', 'المدينة', 'الدير', 'الهارثة'],
  'بغداد': ['الكرادة', 'المنصور', 'الكاظمية', 'الأعظمية', 'مدينة الصدر', 'الشعلة', 'البياع', 'الدورة', 'السيدية', 'اليرموك', 'الغزالية', 'الجهاد', 'العامرية'],
  // Users can still type districts for others using datalist
}
