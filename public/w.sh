...
docker run -d -p 8080:8080 --name evolution-api --restart always -e AUTHENTICATION_API_KEY=QamarAlFayhaa2026 -e AUTHENTICATION_TYPE=apikey -e CORS_ORIGIN="*" atilaalfen/evolution-api:v1.8.3
